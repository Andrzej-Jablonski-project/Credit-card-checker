...
},{"./checkCardNumber":"34BOe"}],"34BOe":[function(require,module,exports) {
// eslint-disable-next-line no-undef
...
module.exports.checkCardNumber = cardNumber => {
  if (typeof cardNumber === "string") {
    cardNumber = parseInt([...cardNumber].filter(el => el !== " " & el !== "-").join(""));
...
},{"./isCardNumberValid":"4VNX6","./getCardProvider":"5N7vh"}],"4VNX6":[function(require,module,exports) {
// eslint-disable-next-line no-undef
...
function calculateOddIndex(digits) {
  ...
  const result = digitsOddIndex.map(digit => digit * 2 >= 10 ? Math.floor(digit * 2 / 10) + digit * 2 % 10 : digit * 2);
...
},{}],"5N7vh":[function(require,module,exports) {
// eslint-disable-next-line no-undef
...
},{"./cardsData":"7hFLH"}],"7hFLH":[function(require,module,exports) {
// eslint-disable-next-line no-undef
...
},{}]},["1j6wU","3Imd1","5rkFb"], "5rkFb", "parcelRequire3a5c")
